...
SETUP_ENGINE_TEST_SPE51(
    AddSubtractInplacePlaintextSPE51,
...
ALL_ENGINE_TEST(AddSubtractInplacePlaintextSPE51, AddTrio, {
  ...
  EXPECT_EQ(input_ciphertext->polynomial_count(), 3);
